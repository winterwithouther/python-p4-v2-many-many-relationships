...
class Employee(db.Model):
    ...
    # Relationship mapping the employee to related meeetings
    meetings = db.relationship("Meeting", secondary=employee_meetings, back_populates="employees")

    # Relationship mapping the mployee to related assignments
...
# Assoication Model to store many-to-many relationship between employee and project
